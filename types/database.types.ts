...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      notifications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "notifications_related_service_order_id_fkey"
            columns: ["related_service_order_id"]
            isOneToOne: false
      ...
      reviews: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "reviews_service_order_id_fkey"
            columns: ["service_order_id"]
            isOneToOne: false
            referencedRelation: "service_orders"
            referencedColumns: ["id"]
      ...
      service_categories: {
        Row: {
          ...
          id: string
          label: string
          slug: Database["public"]["Enums"]["service_category_slug"]
        }
        Insert: {
          icon?: string | null
          id?: string
      ...
      support_tickets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "support_tickets_related_service_order_id_fkey"
            columns: ["related_service_order_id"]
            isOneToOne: false
            referencedRelation: "service_orders"
            referencedColumns: ["id"]
    ...
    Enums: {
      listing_status: "pending" | "published" | "rejected" | "suspended"
      notification_type:
        | "booking_received"
        | "booking_confirmed"
        | "booking_rejected"
      ...
      order_status:
        ...
        | "completed"
        | "refunded"
      payment_method: "orange_money" | "mtn_momo" | "card"
      payment_status:
        | "pending"
        | "processing"
        | "success"
      ...
      property_type:
        ...
        | "hotel"
        | "residence"
      rental_mode: "courte_duree" | "longue_duree" | "les_deux"
      review_target_type: "property" | "service" | "activity"
      service_category_slug:
        | "transport"
        | "restauration"
        | "location_vehicule"
        | "guide"
      user_role: "client" | "host" | "provider" | "admin"
